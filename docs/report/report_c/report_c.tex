...
It is also noted that the chosen approach has changed since Seminar A due to the inclusion of security in the design goals which had been justified by Seminar A feedback \cite{AutotestConversation}.

\unchapter{5}{Implementation}

\section{Core Architecture}

\section{Modules (or Modular Design)}
\subsection{Core Module}
\subsection{Parser Module}
\subsection{Test Case Definition}
\subsection{Test Case Scheduler Module}
\subsection{Test Case Runner Module}
\subsection{Sandbox Container}
